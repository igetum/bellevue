...
class Game
  ...
  def display_instructions
    ...
    puts "challenges you to guess it."

    puts "You will be allowed to select 5 consonants and 1 vowel. If these"
    puts "letters exist in the word, they would display onscreen with the"
    puts "unknown letters represented as an underscore."
  ...
  def select_word
    ...
    #AC - DOUBLED THE AMOUNT OF WORDS
    words = ["W I N D O W", "S T A T I O N", "H A M B U R G E R",
             ...
             "H A P P Y", "N O T I C E", "J U M P Y", "B E L O N G", 
             "M U R K Y", "F O R C E", "S E P A R A T E", "T R U E", 
             "C O N T I N U E", "R E T U R N", "T A S T E L E S S", 
             "S I G N I F Y", "C O N S O L E", "S T U P E N D O U S",
             "G U A R D E D", "S A T I A T E", "H O L L O W", "U P R O O T", 
             "D I S T U R B E D", "P R E A C H"]
  ...
  def get_consonants
    ...
    5.times do  #Iterate 5 times
      ...
      if list.length >= 1 then
        print "Selected consonants: " + list.join(' ') + "\n\n"
      end
...
loop do
  ...
  break if answer =~ /y|h|n/i  #Accept upper or lower case input
...
if answer == "n" or answer == "N" #See if the player elected not
  ...
  loop do  #Loop forever
    ...
    #AC - added instructions with H after game ends. 
    if playAgain == "h" then
      WordGuess.display_instructions
      #Execute the game class's display_instructions method
    end
